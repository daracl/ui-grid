...
export default abstract class Renderer {
  ...
  constructor(form: DaraForm, field: EditRenderer, rowElement: HTMLElement) {
    this.daraForm = form;
    this.field = field;
  ...
  public static getDescriptionTemplate(field: EditRenderer): string {
    return field.description ? `<div class="df-description">${field.description}</div>` : "";
  }

  public changeEventCall(field: EditRenderer, e: Event | null, rederInfo: Render, fieldValue: any): boolean | undefined {
    if (field.onChange) {
      let changeInfo: any = {
        field: field,
        evt: e,
  ...
  public static valuesValueKey(field: EditRenderer): string {
    return field.listItem?.valueField ? field.listItem.valueField : "value";
  }

  public static valuesLabelKey(field: EditRenderer): string {

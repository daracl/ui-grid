...
export default class FieldInfoMap {
   ...
   * @returns {EditRenderer}
   */
  public getFieldName(fieldName: string): EditRenderer {
   ...
   * @returns {EditRenderer}
   */
  public get(fieldKey: string): EditRenderer {
   ...
   *
   * @param fieldInfo EditRenderer
   * @returns boolean true or ValidResult
   */
  public getFieldValidation(fieldInfo: EditRenderer, focusFlag: boolean | undefined) {
 ...
 * @param fieldInfo {EditRenderer} field info
 * @param fieldValue {any} form value
 */
function addFormValue(formData: any, fieldInfo: EditRenderer, useTypeValue?: boolean) {
...
function addFieldFormData(formData: FormData, fieldInfo: EditRenderer, useTypeValue?: boolean) {
  if (utils.ignoreValueField(fieldInfo)) {
    return formData;
  }
